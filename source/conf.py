...
# -*- coding: utf-8 -*-
#
# Rust 程式設計從頭開始 documentation build configuration file, created by
# sphinx-quickstart on Sat Dec 17 10:02:57 2016.
#
...
latex_elements = {
    ...
    \setCJKfamilyfont{song}{AR PL UMing TW}
    \setCJKfamilyfont{sf}{AR PL UMing TW}
    \XeTeXlinebreaklocale "zh"
    \XeTeXlinebreakskip = 0pt plus 1pt
    \let\stdsection\section
    \renewcommand\section{\newpage\stdsection}
    \let\stdsphinxincludegraphics\sphinxincludegraphics
    \renewcommand\sphinxincludegraphics{\stdsphinxincludegraphics[scale=0.6]}
    """,
...
epub_basename = 'Rust_Programming'
